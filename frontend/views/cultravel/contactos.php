            ...
            <div class="col- col-sm-5 col-md-auto col-{breakpoint}-auto">
                <div class="">
                    ...
                    <table>
                        ...
                        <tr>
                            <th class="ct-th"><?= Html::img('@web/facebookw2-icon.png', ['class' => 'contact-img-icon']); ?></th>
                            <th class="ct-th"><?= Html::img('@web/insta2-icon.png', ['class' => 'contact-img-icon']); ?></th>
                            <th class="ct-th"><?= Html::img('@web/tt2-icon.png', ['class' => 'contact-img-icon']); ?></th>
                        </tr>
                        <tr>
