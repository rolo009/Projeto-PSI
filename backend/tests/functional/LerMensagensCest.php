...
class LerMensagensCest
{
    public function _before(FunctionalTester $I)
    {
        ...
        $I->submitForm('#login-form', $this->formParamsLogin('pedrorolo@live.com.pt', '123456789'));
    }
...
// tests
    public function VerMensagensTest(FunctionalTester $I)
    {
        ...
        $I->amOnRoute('contactos/view', ['id' => 1]);
        $I->see('Ponto Turistico: Testar Contactos');
        $I->see('teste_contactos@gmail.com');
        $I->see('Atualizar Mensagem');
        $I->seeElement('#contactos-status');
        $I->click('#contactos-status');
        $I->see('Mensagem Lida');
$I->selectOption('form select[name=Contactos[status]]', 'Mensagem Lida');
