...
<div class="row">
    ...
    <div class="col-xs-10 col-sm-8 col-md-6 col-lg-6">
        <?php $form = ActiveForm::begin(['id' => 'registoForm'])?>
            ...
            echo $form->field($model, 'dtaNascimento', ['options' => ['class' => 'label-registo']])->label("Data de Nascimento")->widget(\yii\jui\DatePicker::className(), ['class' => 'hasDatepicker', 'dateFormat' => 'yyyy-MM-dd']);
